# Screenshots for the store pages

Drop the screenshots here. The README, the Thunderstore page and the Nexus description
reference these exact file names:

| File | What to capture | Used in |
|---|---|---|
| `panel.png` | Own backpack dropped and opened, the **Backpack Access** panel visible next to the wheel with two or more players listed (one Allowed, one Locked). | README, Thunderstore, Nexus |
